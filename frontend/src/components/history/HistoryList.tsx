		...
		<ul className="space-y-2">
			{gameHistory.map((game) => (
				<li
					...
					className="group flex flex-col lg:flex-row items-center justify-between p-4 bg-white rounded-lg shadow-sm border border-gray-200 cursor-pointer hover:bg-blue-100 hover:shadow-md transition-all duration-200"
				>
